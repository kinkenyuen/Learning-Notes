...
* [两种方案对比](#两种方案对比)
* [研究前提](#研究前提)
* [先Hook Child 再Hook Super](#先hook-child-再hook-super)
  * [Child、Super均未实现方法](#childsuper均未实现方法)
     * [Child用方案A_Super用方案A](#child用方案a_super用方案a)
     * [Child用方案A_Super用方案B](#child用方案a_super用方案b)
     * [Child用方案B_Super用方案A](#child用方案b_super用方案a)
     * [Child用方案B_Super用方案B](#child用方案b_super用方案b)
  * [Child实现方法，Super未实现方法](#child实现方法super未实现方法)
     * [Super用方案A](#super用方案a)
     * [Super用方案B](#super用方案b)
  * [Child未实现方法、Super实现方法](#child未实现方法super实现方法)
     * [Child用方案A](#child用方案a)
     * [Child用方案B](#child用方案b)
  * [Child、Super均实现方法](#childsuper均实现方法)
* [先Hook Super 再Hook Child](#先hook-super-再hook-child)
  * [Child、Super均未实现方法](#childsuper均未实现方法-1)
     * [Child用方案A_Super用方案A](#child用方案a_super用方案a-1)
     * [Child用方案A_Super用方案B](#child用方案a_super用方案b-1)
     * [Child用方案B_Super用方案A](#child用方案b_super用方案a-1)
     * [Child用方案B_Super用方案B](#child用方案b_super用方案b-1)
  * [Child实现方法，Super未实现方法](#child实现方法super未实现方法-1)
     * [Super用方案A](#super用方案a-1)
     * [Super用方案B](#super用方案b-1)
  * [Child未实现方法、Super实现方法](#child未实现方法super实现方法-1)
     * [Child用方案A](#child用方案a-1)
     * [Child用方案B](#child用方案b-1)
  * [Child、Super均实现方法](#childsuper均实现方法-1)
* [总结](#总结)
* [REF](#ref)
...
1. 方案A明显优于方案B
2. 从调用顺序（执行路径来看），先Hook Super再Hook Child更安全，在某些情况下先Hook Child再Hook Super，Super的方法会被忽略
